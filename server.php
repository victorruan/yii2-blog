...
define('WEBPATH', realpath(__DIR__ . '/framework/'));
...
{
    $server = Swoole\Protocol\WebServer::create(__DIR__ . '/config/app.ini');
    ...
    $server->run(array('worker_num' => 1, 'max_request' => 5000, 'log_file' => ROOTPATH.'/logs/app.log'));
});
